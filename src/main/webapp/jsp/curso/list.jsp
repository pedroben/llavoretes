...
<%@page import="net.llavoretes.dao.CursoDao"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.Iterator"%>

<%
    CursoDao oCursoDao = new CursoDao(Conexion.getConection());
    ArrayList<String> alColumnsNames = (ArrayList<String>) oCursoDao.getColumnsNames();
    Iterator<String> oIterador = alColumnsNames.listIterator();
    String strNombreMantenimiento = "curso";
%>
        ...
        <div class="row-fluid">
            ...
            <div class="span5">
                <div class="text-right">
                    ...
                    <form class="navbar-form pull-right" action="Controller" method="post" id="cursoForm">
                        <fieldset>                                                                     
                            <span>
