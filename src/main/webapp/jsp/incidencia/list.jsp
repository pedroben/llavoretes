<%-- 
    Document   : list
    Created on : 20-feb-2014, 11:39:21
    Author     : llavoretes
--%>
<%@page import="net.llavoretes.helper.Conexion"%>
<%@page import="net.llavoretes.dao.IncidenciaDao"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.Iterator"%>
<%
    IncidenciaDao oIncidenciaDao = new IncidenciaDao(Conexion.getConection());
    ArrayList<String> alColumnsNames = (ArrayList<String>) oIncidenciaDao.getColumnsNames();
    Iterator<String> oIterador = alColumnsNames.listIterator();
    String strNombreMantenimiento = "incidencia";
%>
        ...
        <div class="row-fluid">
            ...
            <div class="span5">
                <div class="text-right">
                    ...
                    <form class="navbar-form pull-right" action="Controller" method="post" id="incidenciaForm">
                        <fieldset>                                                                     
                            <span>
