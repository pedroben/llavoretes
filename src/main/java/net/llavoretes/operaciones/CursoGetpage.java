...
public class CursoGetpage implements GenericOperation{
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<CursoBean> oCurso = oCursoDAO.getPage(rpp, page, alFilter, hmOrder);
            ...
            throw new ServletException("CursoGetPageJson: View Error: " + e.getMessage());
        }
    }
