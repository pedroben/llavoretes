...
public class IncidenciaGetpages implements GenericOperation{
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oIncidenciaDAO.getPages(rpp, alFilter, hmOrder);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("IncidenciaGetpagesJson: View Error: " + e.getMessage());
        }
    }
