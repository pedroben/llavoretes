...
public class CursoGetregisters implements GenericOperation{
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oCursoDAO.getCount(alFilter);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("CursoGetregistersJson: View Error: " + e.getMessage());
        }
    }
