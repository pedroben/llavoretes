 ...
 * @author al037184
 */
public class GrupoGetpage implements GenericOperation{
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            List<GrupoBean> oGrupo = oGrupoDAO.getPage(rpp, page, alFilter, hmOrder);
            ...
            throw new ServletException("GrupoGetPageJson: View Error: " + e.getMessage());
        }
    }
